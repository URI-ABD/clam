# CLAM: Clustering, Learning and Approximation with Manifolds (v0.23.1)
...
CLAM is a library crate so you can add it to your crate using `cargo add abd_clam@0.23.1`.
