# CLAM: Clustered Learning of Approximate Manifolds (v0.21.3-dev0)
...
CLAM is a library crate so you can add it to your crate using `cargo add abd_clam@0.21.3-dev0`.
