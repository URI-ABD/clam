# CLAM: Clustering, Learning and Approximation with Manifolds (v0.22.4)
...
CLAM is a library crate so you can add it to your crate using `cargo add abd_clam@0.22.4`.
