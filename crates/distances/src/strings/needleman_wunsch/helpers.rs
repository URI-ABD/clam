...
///
/// Expects `x` and `y` to be aligned sequences generated by `traceback_iterative` or `traceback_recursive`.
...
/// Expects to receive two strings which were aligned using either `traceback_iterative` or `traceback_recursive`.
///
/// # Arguments
///
/// * `x`: An aligned string.
