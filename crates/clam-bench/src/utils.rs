...
pub fn configure_logger(args: &super::Args) -> Result<(LoggerGuard, PathBuf), String> {
    // TODO: Use all args to create a name for the log file.
    let file_name = format!("{:?}", args.data_type);
